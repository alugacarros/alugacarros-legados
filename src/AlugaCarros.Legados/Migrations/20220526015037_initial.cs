        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdVehicleGroup = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    JwsAlgorithm = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    JweAlgorithm = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    JweEncryption = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IdIdentity = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    IdGroup = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    IdAgency = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vehicles_VehicleGroups_IdGroup",
                        column: x => x.IdGroup,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_IdGroup",
                table: "Vehicles",
                column: "IdGroup");

            migrationBuilder.Sql(@"
                    Insert Into VehicleGroups(GroupCode, GroupDescription)
                    Select 'A1', 'Hatch Entrada' 
                    Union
                    Select 'A2', 'Hatch Intermediário'
                    Union 
                    Select 'A3', 'Hatch Premium' 
                    Union
                    Select 'B1', 'Sedan Entrada' 
                    Union
                    Select 'B2', 'Sedan Intermediário' 
                    Union
                    Select 'B3', 'Sedan Premium' 
                    Union
                    Select 'C1', 'Utilitário Entrada' 
                    Union
                    Select 'C2', 'Utilitário Intermediário'
                    Union
                    Select 'C3', 'Utilitário Premium'
